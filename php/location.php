      ...
      <header>
        ...
        <nav>
            <ul class="links ul-nav">
                <!-- <li class="links"><a href="./php/">Home</a></li>
                <li class="links"><a href="/php/FAQs.php">FAQ's</a></li>
                <li class="links"><a href="/php/About us.php">About us </a></li>
                <li class="links"><a href="/php/privacypolicy.php">Privacy policy </a></li>
                <li class="links"><a href="/php/reviews.php">Customer reviews </a></li>
                <li class="links"><a href="/php/contactt.php">Contact us</a></li>
                <li class="links"><a href="/php/offer.php">Offers</a></li>
                <li class="links"><a href="../php/location.php">Locations</a></li> -->

                <li class="links"><a href="../html/index.html">Home</a></li>
          <li class="links"><a href="./FAQ.html">FAQ's</a></li>
...
<div class="map1">
  ...
  // Display location data
    while($row = $result->fetch_assoc()) {
        echo "<p>Location: " . $row["location_name"]. "<br>";
        echo "Address: " . $row["address"]. "<br>";
        echo "Phone: " . $row["phone"]. "<br><br></p>";
    }
    ?>
</div> -->
